...
import type { Event as EventType } from "@/lib/types/api";
...
export default function EventsPage() {
  ...
  const { data: eventsResp, isLoading: eventsLoading } = useEvents({
    limit: 12,
    status: "published",
  });
  const events: EventType[] = eventsResp?.data ?? [];
  ...
  const formatTimeRange = (event: EventType) => {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-green-600 mb-8 max-w-3xl mx-auto text-pretty">
              Stay updated with upcoming events, workshops, and community
              outreach programs. Join hundreds of corps members in making a
              positive impact in Jos North.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {eventsLoading ? (
              ...
              events.map((event, index) => {
                ...
                const statusLabel = event.status ?? "Event";
