  ...
  return (
    <section className="py-24 px-4 bg-gradient-to-br from-cyan-50 via-white to-teal-50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900 mb-4 text-balance">Development Team</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto text-pretty">
            Talented developers and engineers powering the NYSC Jos North digital platform
          </p>
        </div>
          ...
          {devTeam.map((dev, index) => (
            ...
            >
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-gray-900 text-lg">{dev.name}</CardTitle>
                <CardDescription className="text-cyan-600 font-semibold">{dev.role}</CardDescription>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-center gap-3 pt-2">
                    <button className="p-2 text-gray-600 hover:text-cyan-600 hover:bg-cyan-100 rounded-full transition-colors">
