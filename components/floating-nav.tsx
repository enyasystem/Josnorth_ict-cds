    ...
    <>
      ...
      <motion.nav
        ...
        className={`fixed w-[90%] left-[5%] top-4 z-50 flex justify-between items-center px-8 py-4 transition-all duration-500 rounded-[35px] ${{
          ...
          false: "bg-white/30 backdrop-blur-xl border border-green-200 shadow-xl",
        }[String(isScrolled)]}`}
      >
        <Logo />
        ...
        <div className="hidden md:flex space-x-8 font-semibold text-green-900">
          ...
          <Link href="/team" className="hover:text-green-700 transition">
            Excos & Devs
          </Link>
          <Link href="/events" className="hover:text-green-700 transition">
            Events
          </Link>
          <Link href="/resources" className="hover:text-green-700 transition">
            Resources
          </Link>
        </div>
