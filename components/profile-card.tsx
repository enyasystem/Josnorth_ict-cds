  ...
  return (
    <div className="profile-card rounded-3xl bg-white p-6 shadow-md">
      <div className="flex flex-col items-center">
        <img src={img} alt={name} className="w-32 h-32 mx-auto rounded-full mb-4 object-cover border-4 border-green-100" />
        ...
        <div className="profile-socials" aria-label={`${name} social links`}>
          <a href={gh} aria-label="GitHub" title="GitHub" target="_blank" rel="noopener noreferrer">
          ...
          <a href={li} aria-label="LinkedIn" title="LinkedIn" target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
          ...
          <a href={x} aria-label="X (Twitter)" title="X (Twitter)" target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
          ...
          <a href={ig} aria-label="Instagram" title="Instagram" target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        ...
        <p className="text-gray-600 mt-4 text-center">{bio ?? "Active in community projects and developer initiatives."}</p>

        <div className="flex gap-3 mt-4">
          <a href="#" className="px-4 py-2 rounded-full bg-green-600 text-white text-sm">View profile</a>
          <a href="#" className="px-4 py-2 rounded-full bg-white border border-green-200 text-green-700 text-sm">Message</a>
        </div>
      </div>
    </div>
  )
