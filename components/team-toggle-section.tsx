  ...
  return (
    <section className="py-24 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl font-bold text-foreground mb-4 text-balance">Our Team</h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
            Meet the dedicated leaders and developers powering NYSC Jos North CDS
          </p>
        </div>
        ...
        <div className="flex justify-center gap-4 mb-12 flex-wrap">
          ...
          <button
            ...
            style={{
              animation: isVisible ? "fadeInUp 0.8s ease-out 0.15s both" : "none",
            }}
          >
            Development Team
          </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {members.map((member, index) => (
            <Card
              ...
              style={{
                animation: isVisible ? `fadeInUp 0.8s ease-out ${0.2 + index * 0.1}s both` : "none",
              }}
            >
              ...
              <CardContent>
                ...
                <div className="flex justify-center gap-3">
                  <button className="p-2 text-muted-foreground hover:text-primary hover:bg-secondary rounded-full transition-all transform hover:scale-110">
